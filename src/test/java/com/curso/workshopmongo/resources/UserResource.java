...
public class UserResource {
    ...
    @PutMapping("/{id}")  // Utilizando o @GetMapping, mais específico para requisições GET
    ...
    @RequestMapping(value = "/{id}/posts", method = RequestMethod.GET)  // Utilizando o @GetMapping, mais específico para requisições GET
